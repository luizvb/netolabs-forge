...
import { GuestDemo, PENDING_DRAFT_KEY } from './pages/GuestDemo';
...
export function App() {
  ...
  if (state === 'guest') return <Routes><Route path="/" element={<Landing/>}/><Route path="/demo" element={<GuestDemo/>}/><Route path="/auth" element={<AuthPage onAuth={load}/>}/><Route path="*" element={<Navigate to="/auth" replace/>}/></Routes>;
